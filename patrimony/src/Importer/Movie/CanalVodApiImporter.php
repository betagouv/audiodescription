 ...
 */
class CanalVodApiImporter implements MovieImporterInterface
{
    ...
    public function import(?array $options = []): void
    {
        ...
        $url = $this->parameterBag->get('canal_vod.api.url');
        ...
        // Create partner CANAL VOD if not exists.
        $partnerRepository = $this->entityManager->getRepository(Partner::class);
        $partner = $partnerRepository->findOneBy(['code' => PartnerCode::CANAL_VOD->value]);

        if (is_null($partner)) {
            $partner = new Partner();
            $partner->setCode(PartnerCode::CANAL_VOD->value);
            $partner->setName(PartnerCode::CANAL_VOD->value);
