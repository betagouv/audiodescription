...
{
    /** @var EntityRepository<Partner> */
    private EntityRepository $partnerRepository;
    /** @var EntityRepository<Offer> */
   ...
   */
    ...
    /**
     * @param array<mixed> $program
     * @SuppressWarnings(PHPMD.CyclomaticComplexity)
     * @SuppressWarnings(PHPMD.NPathComplexity)
     * @SuppressWarnings(PHPMD.ExcessiveMethodLength)
     */
    private function importProgram(array $program, bool $createMoviesOption): void
    {
        $isTelefilm = 0;
        ...
        if (!is_null($startRights) && !is_null($endRights)) {
            ...
            if (
              ...
              // ExternalIds
                ...
                if (isset($program['imdb']['episode_id'])) {
                    $ids['imdbId'] = $program['imdb']['episode_id'];
                }

                if (isset($program['plurimedia_broadcast_id'])) {
                    $ids['plurimediaId'] = $program['plurimedia_broadcast_id'];
                }

                if (isset($program['allocine']['movie_id'])) {
    ...
    private function requestAndImport(string $url, bool $createMoviesOption): void
    {
