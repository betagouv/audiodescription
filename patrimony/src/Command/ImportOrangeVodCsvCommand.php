...
class ImportOrangeVodCsvCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $importer = $this->importerFactory->createImporter(ImportSourceType::ORANGE_VOD_CSV);
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setDescription('Import solutions from Orange VOD csv file.')
            // the command help shown when running the command with the "--help" option
            ->setHelp('This command is used to import solutions from Orange VOD csv file.')
            ->addOption(
                'create-movies',
                null,
