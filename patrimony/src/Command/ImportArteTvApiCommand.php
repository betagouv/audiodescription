...
class ImportArteTvApiCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $importer = $this->importerFactory->createImporter(ImportSourceType::ARTE_TV_API);
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setDescription('Import solutions from Arte file.')
            // the command help shown when running the command with the "--help" option
            ->setHelp('This command is used to import solutions from Arte file.')
            ->addOption(
                'create-movies',
                null,
