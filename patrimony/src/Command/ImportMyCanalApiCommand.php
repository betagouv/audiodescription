...
#[AsCommand(name: 'ad:import:mycanal-api')]
class ImportMyCanalApiCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $importer = $this->importerFactory->createImporter(ImportSourceType::MY_CANAL_API);
