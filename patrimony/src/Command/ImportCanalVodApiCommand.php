...
#[AsCommand(name: 'ad:import:canalvod-api')]
class ImportCanalVodApiCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $importer = $this->importerFactory->createImporter(ImportSourceType::CANAL_VOD_API);
