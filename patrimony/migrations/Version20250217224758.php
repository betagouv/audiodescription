 ...
 */
final class Version20250217224758 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE patrimony.genre (id UUID NOT NULL, main_genre_id UUID DEFAULT NULL, name VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE patrimony.movie (id INT NOT NULL, public_id UUID DEFAULT NULL, title VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, cnc_id VARCHAR(255) DEFAULT NULL, arte_id VARCHAR(255) DEFAULT NULL, canal_vod_id VARCHAR(255) DEFAULT NULL, orange_vod_id VARCHAR(255) DEFAULT NULL, allocine_id VARCHAR(255) DEFAULT NULL, la_cinetek_id VARCHAR(255) DEFAULT NULL, france_tv_id VARCHAR(255) DEFAULT NULL, isan_id VARCHAR(255) DEFAULT NULL, visa VARCHAR(255) DEFAULT NULL, has_ad BOOLEAN NOT NULL, poster TEXT DEFAULT NULL, synopsis TEXT DEFAULT NULL, duration INT DEFAULT NULL, production_year INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE patrimony.movie_nationality (movie_id INT NOT NULL, nationality_id UUID NOT NULL, PRIMARY KEY(movie_id, nationality_id))');
        $this->addSql('CREATE INDEX IDX_9BD19A9A8F93B6FC ON patrimony.movie_nationality (movie_id)');
        $this->addSql('CREATE INDEX IDX_9BD19A9A1C9DA55 ON patrimony.movie_nationality (nationality_id)');
        $this->addSql('COMMENT ON COLUMN patrimony.movie_nationality.nationality_id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE patrimony.movie_genre (movie_id INT NOT NULL, genre_id UUID NOT NULL, PRIMARY KEY(movie_id, genre_id))');
        $this->addSql('CREATE INDEX IDX_57EC81D28F93B6FC ON patrimony.movie_genre (movie_id)');
        $this->addSql('CREATE INDEX IDX_57EC81D24296D31F ON patrimony.movie_genre (genre_id)');
        $this->addSql('COMMENT ON COLUMN patrimony.movie_genre.genre_id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE patrimony.movie_director (movie_id INT NOT NULL, director_id UUID NOT NULL, PRIMARY KEY(movie_id, director_id))');
        $this->addSql('CREATE INDEX IDX_3F6E238F8F93B6FC ON patrimony.movie_director (movie_id)');
        $this->addSql('CREATE INDEX IDX_3F6E238F899FB366 ON patrimony.movie_director (director_id)');
        $this->addSql('COMMENT ON COLUMN patrimony.movie_director.director_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE patrimony.partner (id UUID NOT NULL, name VARCHAR(255) NOT NULL, pronunciation VARCHAR(255) DEFAULT NULL, code VARCHAR(255) NOT NULL, display_order INT DEFAULT NULL, condition TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE patrimony.movie_nationality ADD CONSTRAINT FK_9BD19A9A8F93B6FC FOREIGN KEY (movie_id) REFERENCES patrimony.movie (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE patrimony.movie_nationality ADD CONSTRAINT FK_9BD19A9A1C9DA55 FOREIGN KEY (nationality_id) REFERENCES patrimony.nationality (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE patrimony.movie_genre ADD CONSTRAINT FK_57EC81D28F93B6FC FOREIGN KEY (movie_id) REFERENCES patrimony.movie (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE patrimony.movie_genre ADD CONSTRAINT FK_57EC81D24296D31F FOREIGN KEY (genre_id) REFERENCES patrimony.genre (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE patrimony.movie_director ADD CONSTRAINT FK_3F6E238F8F93B6FC FOREIGN KEY (movie_id) REFERENCES patrimony.movie (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE patrimony.movie_director ADD CONSTRAINT FK_3F6E238F899FB366 FOREIGN KEY (director_id) REFERENCES patrimony.director (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patrimony.movie_nationality DROP CONSTRAINT FK_9BD19A9A8F93B6FC');
        $this->addSql('ALTER TABLE patrimony.movie_nationality DROP CONSTRAINT FK_9BD19A9A1C9DA55');
        $this->addSql('ALTER TABLE patrimony.movie_genre DROP CONSTRAINT FK_57EC81D28F93B6FC');
        $this->addSql('ALTER TABLE patrimony.movie_genre DROP CONSTRAINT FK_57EC81D24296D31F');
        $this->addSql('ALTER TABLE patrimony.movie_director DROP CONSTRAINT FK_3F6E238F8F93B6FC');
        $this->addSql('ALTER TABLE patrimony.movie_director DROP CONSTRAINT FK_3F6E238F899FB366');
        ...
        $this->addSql('DROP TABLE patrimony.movie_nationality');
        $this->addSql('DROP TABLE patrimony.movie_genre');
        $this->addSql('DROP TABLE patrimony.movie_director');
