...
|-----------------|---------------------------------------|---------------------|----------------------------------------------|
| `patrimony`     | Dockerfile personnalisé (Caddy + PHP) | `ad-network`, `web` | `patrimony.audiodescription.culture.gouv.fr` |
| `drupal`        | Dockerfile personnalisé (Caddy + PHP) | `ad-network`, `web` | `audiodescription.culture.gouv.fr`              |
