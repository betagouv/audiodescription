...
| `pt-cron-import`     | Importer tous les films depuis les sources partenaires dans Patrimony                             |
| `d-cron-import`      | Synchroniser avec Drupal avec Patrimony                                                           |
...
| `pt-deploy`             | Exécute `composer install` et les migrations                                                                | |
...
| `d-install`             | Installe l'environnement Drupal (`composer install`, installation du site et de la configuration...)        |                                                       |
| `d-deploy`              | Déploie une nouvelle version du projet (`composer install`, mise à jour de la configuration, migrations...) |                                                       |
