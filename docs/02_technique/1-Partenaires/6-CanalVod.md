...
* **Format :** API
* **URL :** Variable d'environnement `CANAL_VOD_API_URL`
...
* `replay` : Seuls les films disponibles en TVOD.
...
```bash
bin/console ad:import:canal-vod-api
bin/console ad:import:canal-vod-api --create-movies=true
```
...
`patrimony/src/Importer/Movie/CanalVodApiImporter.php`
