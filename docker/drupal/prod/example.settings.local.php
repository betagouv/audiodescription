 ...
 * @endcode
 */
$settings['hash_salt'] = '2jfqxx6SEiaMkHsO4gcfIa8OKOPURnhBd-jxPpUH4PBex27HPh3C5TJOtIATXpVwkrFQMgovfg';
...
$settings['sendethic_account_id'] = '';
$settings['sendethic_api_key'] = '';

/** if (file_exists($app_root . '/' . $site_path . '/settings.oidc.php')) {
include $app_root . '/' . $site_path . '/settings.oidc.php';
}
...
if (file_exists($app_root . '/' . $site_path . '/settings.s3.php')) {
include $app_root . '/' . $site_path . '/settings.s3.php';
}

if (file_exists($app_root . '/' . $site_path . '/settings.smtp.php')) {
include $app_root . '/' . $site_path . '/settings.smtp.php';
} **/
